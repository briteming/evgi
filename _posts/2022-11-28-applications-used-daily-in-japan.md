...
> 2026 年更新说明，在 2022 年编写这篇文章的时候，我对日本还不算了解，现在我已经在日本居住超过 3 年，这期间我开设了另外一个日本生活记录相关的[博客](https://evjp.life)。如果大家对日本生活必备的应用还有需求，这篇文章已经在 2026 年做了更新。如果大家想要了解真实的日本生活，可以访问我另外的[博客](https://evjp.life)
...
- 小红书，虽然 SUUMO/Homes 这一类本土网站上能看到挂牌的租房信息，但是相对来说更新频率较低，如果想要尽快找到落脚的地方，推荐小红书寻找有经验的华人中介，如有需求也可以通过网站或邮箱联络我
- [SUUMO](https://evjp.life/p/263.html)，日本最大的租房网站
- Homes
...
- 「Yahoo!乗換案内」，日本的电车非常发达，下载了一张东京都的地铁线路图得放大好几倍才能找到我想要查的站点，乘换案内解决了电车换乘的问题，当然用 Google Maps 也可以，但这个应用在换乘，列车到站时间等方面给的信息更多，不过需要注意的是 Yahoo 的应用对于站名只支持输入日语，所以对于刚到日本不熟悉日语的朋友，还是推荐 Google Map。
...
- ~~Felo 实时翻译，这是一个非常简洁的应用，设置好语言之后，只有一个按钮，就是开启实时翻译，如果设置中文和日语，在界面上马上就能识别出当前说话的内容。~~ Felo 翻译订阅太贵，对于低频的需求，价格过高
...
- 食べログ，美食点评，一款类似于大众点评的应用，听朋友说这上面的打分超过 3.2 的就可以尝试一下了，日本人打分可能比较严格吧。不过用的更多的还是直接在 Google Map 上查。
- [ホットペッパーグルメ](https://evjp.llife/p/483.html)，Hot Pepper，可以在上面发现新餐厅，预约餐厅
...
- ID Photo，利用手机制作证件照，然后再利用 PrintSmash 在便利店打印照片
- PrintSmash，可以去线下便利店打印文件
