...
- 5X 奖赏钱
  - 奖赏钱 RC 可以 1:1 还款信用卡
  - 奖赏钱可以 1:10 兑换国泰航空里程
  - RC 可以直接 1:50 兑换香港常用的消费积分软件易赏钱 MoneyBack
  - RC 兑换到了 MoneyBack 之后，还可以互换积分到汇丰或者国泰航空或者花旗
- 内地及澳门额外 4.4% 回赠
- 港币或人民币结算，免汇率波动烦忧
...
另外如果你手里有 USDT、USDC 等稳定币，又不想每次都为换汇转账到券商发愁，可以看看 [BIT](https://invest.matrixport.com/newRegister/cn?invite_code=XMVUEK)（原 Matrixport），用稳定币就能直接买入真实美股，省去海外银行卡中转的麻烦。
