...
aliases: ["mise 的 minimum_release_age 给新版本加一道冷静期的供应链安全机制", "mise minimum_release_age 供应链安全"]
tagline: ""
description: "mise 从 v2026.6.2 开始为所有能提供发布时间戳的后端默认启用 minimum_release_age，新发布的工具版本要等 24 小时才会被安装。这篇文章讲清楚这条 WARN 警告的含义、这个机制的来龙去脉、它与 Renovate 和 pnpm 同类功能的对比，以及全局配置、按工具覆盖、排除列表和临时绕过的具体用法。"
category: "经验总结"
tags: [mise, supply-chain-security, version-manager, devtools, npm, security, cli]
create_time: 2026-08-04 10:00:00
last_updated: 2026-08-04 10:00:00
---
