...
tagline: "一次 PVE 硬盘迁移救急，让我重新认识了抽屉里的旧手机"
description: "从一次 Proxmox VE 硬盘迁移时网口不通的救急经历说起，讲清楚 Android USB 网络共享的原理与在 Linux 上的配置方法，并整理旧安卓手机可以承担的其他角色：Termux 服务器、投屏调试、USB 摄像头、应急启动盘、串口终端、免 root 抓包等。"
category: 经验总结
tags: [ android, usb-tethering, rndis, termux, proxmox-ve, scrcpy, adb, homelab, linux, old-phone-reuse ]
